<?php /* Smarty version 2.6.26, created on 2017-03-13 16:40:33
 ...
 ?>
		...
		<h1>予約をする</h1>
	 		<?php if ($this->_tpl_vars['result_messages']): ?>
				<span class="txt-red txt-sm"><?php echo $this->_tpl_vars['result_messages']; ?>
</span><br />
			<?php endif; ?>
			...
			<form action="" method="post">
				<div class="box-inner">
					...
					<dl class="mt20">
						...
						<dd><input name="email" type="email" class="w100" value="<?php echo $this->_tpl_vars['input_data']['email']; ?>
"></dd>
						<dt>パスワード</dt>
						<dd><input name="password" type="password" class="w100" value="<?php echo $this->_tpl_vars['input_data']['password']; ?>
"></dd>
					</dl>
