<?php /* Smarty version 2.6.26, created on 2016-11-22 20:00:39
         compiled from member/magazin.tpl */ ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "header_magazin.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			...
			<div class="content-inner">
				...
				<table class="table mt10">
					<tr>
						<th>メルマガ</th>
						<td>
					          <input type="radio" id="" name="email_flg" value="0" <?php if ($this->_tpl_vars['input_data']['email_flg'] == 0): ?>checked<?php endif; ?>  />配信停止
					          <input type="radio" id="" name="email_flg" value="1" <?php if ($this->_tpl_vars['input_data']['email_flg'] == 1): ?>checked<?php endif; ?>  />配信中
						</td>
					</tr>
				</table>
