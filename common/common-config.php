...
//管理者のメールアドレス
 define("SITE_ADMIN_EMAIL", "info@whiteningbar.net");

//メールのReturn-Pathのアドレス
define("RETURN_EMAIL", "info@whiteningbar.net");


//お問い合わせ用メールアドレス
define("INQ_ADMIN_EMAIL", "info@whiteningbar.net");

// メール差出人設定
// define("MAIL_FROM", "info@whiteningbar.net"); // by arafat
define("MAIL_FROM", "	arafat.fci123@gmail.com");
