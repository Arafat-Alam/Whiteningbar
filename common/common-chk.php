...
//********* 店舗登録 **********************************
	...
	public  static $operateCheckData = Array(
	   "dbstring" =>  array(
			...
			"to_2_h" 		=> "営業時間（月）の終了時間",
			"to_2_m" 		=> "営業時間（月）の終了分",
			"from_3_h" 		=> "営業時間（月）の開始時間",
			"from_3_m" 		=> "営業時間（月）の開始分",
			"to_3_h" 		=> "営業時間（月）の終了時間",
			"to_3_m" 		=> "営業時間（月）の終了分",
			"from_4_h" 		=> "営業時間（月）の開始時間",
			"from_4_m" 		=> "営業時間（月）の開始分",
			"to_4_h" 		=> "営業時間（月）の終了時間",
			"to_4_m" 		=> "営業時間（月）の終了分",
			"from_5_h" 		=> "営業時間（月）の開始時間",
			"from_5_m" 		=> "営業時間（月）の開始分",
			"to_5_h" 		=> "営業時間（月）の終了時間",
			"to_5_m" 		=> "営業時間（月）の終了分",
			"from_6_h" 		=> "営業時間（月）の開始時間",
			"from_6_m" 		=> "営業時間（月）の開始分",
			"to_6_h" 		=> "営業時間（月）の終了時間",
			"to_6_m" 		=> "営業時間（月）の終了分",
			"from_7_h" 		=> "営業時間（月）の開始時間",
			"from_7_m" 		=> "営業時間（月）の開始分",
			"to_7_h" 		=> "営業時間（月）の終了時間",
			"to_7_m" 		=> "営業時間（月）の終了分",
