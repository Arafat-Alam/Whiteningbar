...
<div id="footer" class="clear mt30">{$smarty.const.FOOTER_COPYRIGHT}</div>
{php}
unset($_SESSION['page']);
unset($_SESSION['tab']);
{/php}

{if $shopNo == 0 and $index == 'index'}
{php}
	...
	function abbreviateNumber(arr) {
        ...
        function monthChartData(chartData){
        	if (chartData == 'lastMonth') {
        		var data = '{/literal}{$prevMonth}{literal}';
        		...
        		var data = '{/literal}{$nextMonth}{literal}';
        		var thisMonth = jQuery.parseJSON(data);
        		...
        		var data = '{/literal}{$thisMonth}{literal}';
        		var thisMonth = jQuery.parseJSON(data);
		...
		function dayChartData(chartData){
        	if (chartData == 'yesterday') {
        		var data = '{/literal}{$prevDay}{literal}';
        		...
        		var data = '{/literal}{$nextDay}{literal}';
        		var thisDay = jQuery.parseJSON(data);
        		...
        		var data = '{/literal}{$thisDay}{literal}';
        		var thisDay = jQuery.parseJSON(data);
